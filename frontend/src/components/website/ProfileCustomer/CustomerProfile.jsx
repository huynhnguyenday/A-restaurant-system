        ...
        <div className="mb-4 ml-20 flex max-w-4xl space-x-6">
          ...
          <div className="w-2/3">
            ...
            <input
              ...
              className="peer block w-3/4 appearance-none border-0 border-b-2 border-gray-300 bg-transparent font-josefin pl-2 pt-2 text-lg text-gray-900 focus:outline-none"
              readOnly
            />
